...
def parse_args():
    ...
    p.add_argument('--checkpoint_dir', default='checkpoints/gen_highres_v4')
...
def main():
    ...
    if mlflow_on:
        mlflow.start_run(run_name="gen-highres-v4"); mlflow.log_params({'epochs': args.epochs, 'lr': args.lr, 'features': '42-dim: stage1 + high-res onset', 'warm_start': 'gen_stage1', 'w8': args.w8, 'w16': args.w16, 'new_col_init': 'random'})
