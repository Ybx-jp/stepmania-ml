...
either direction); only path = AR-head retrain OR bank. Train-C0 generated by `gen_train_c0.py` (4 GPU shards).
Open strategic fork + the nearest-shippable perc-gate/jack items remain. 2nd open thread: 1/16-jack OOD → `fatigue_penalty` 2→3.
